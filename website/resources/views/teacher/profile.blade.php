            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  <img class="profile-user-img img-fluid img-circle" class="img" src="{{('/profile_img/'.$user['image'])}}" alt="User profile picture"/>   
                </div>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                          <input type="number" name="phone" value="{{$user['phone']}}" class="form-control" placeholder="Phone">
                          <div class="input-group-append">
                            <div class="input-group-text">
                        ...
                        <div class="input-group mb-3">
                            <select name="type" class="form-control">
                                ...
                                <option value="faculty" option selected="" disabled>Faculty</option>
                            </select>
                            <div class="input-group-append">
